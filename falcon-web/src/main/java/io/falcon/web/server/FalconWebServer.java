 ...
 */
public class FalconWebServer {

    private static final Logger log = LoggerFactory.getLogger(FalconWebServer.class);
    ...
    public FalconWebServer(WebEnvironment environment, int port) {
    ...
    public void start() {
        try {
            ...
            tomcat.start();
            log.info("Falcon web server started on port {}", port);
    ...
    private class UpdateConfigServlet extends HttpServlet {
        ...
        protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            try {
                ...
                var newConfig = EnvironmentConfig.create()
...
<body>
<div class="header">
    <h1><span>Falcon</span> Dashboard</h1>
